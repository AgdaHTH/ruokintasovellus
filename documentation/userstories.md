...
* Ruuan voi poistaa kohdasta *Delete food*. HUOM! Tämä komento poistaa ruuan kokonaan tietokannasta,
eli kaikilta eläimiltä. Sovelluksessa on vielä toteuttamatta toiminnallisuus, joka mahdollistaisi ruuan poistamisen
vain tietyltä eläimeltä.
