...
Ruuan voi poistaa kohdasta *Delete food*. Linkistä *Add a new food* pääsee lisäämään tietokantaan uuden ruuan (ruokien nimet ovat uniikkeja, joten sovellus ei hyväksy toista samannimistä ruokaa).
